...
class Asset(models.Model):
    ...
    vendor = models.ForeignKey('Manufactory', verbose_name=u'制造商', null=True, blank=True)
...
class Server(models.Model):
    ...
    # vendor = models.ForeignKey(verbose_name=u'制造商',max_length=128,null=True, blank=True)
...
class NetworkDevice(models.Model):
    ...
    # vendor = models.CharField(verbose_name=u'制造商',max_length=128,null=True, blank=True)
    model = models.CharField(u'型号', max_length=128, null=True, blank=True)
...
class Disk(models.Model):
    ...
    vendor = models.CharField(u'制造商', max_length=64, blank=True, null=True)
    ...
    interface_type = models.CharField(u'接口类型', max_length=64, choices=disk_interface_choice, default='SAS')
    memo = models.TextField(u'备注', blank=True, null=True)
    create_date = models.DateTimeField(blank=True, auto_now_add=True)
    update_date = models.DateTimeField(blank=True, null=True)

    auto_create_fields = ['sn', 'slot', 'vendor', 'model', 'capacity', 'interface_type']
...
class NIC(models.Model):
    ...
    def __str__(self):
        return '%s:%s' % (self.asset_id, self.mac)
    ...
    auto_create_fields = ['name', 'sn', 'model', 'mac', 'ip', 'net_mask', 'bonding']
...
class Tag(models.Model):
    ...
    creater = models.ForeignKey(hosts_models.UserProfile)
    create_date = models.DateField(auto_now_add=True)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey(hosts_models.UserProfile, verbose_name=u'事件源')
    memo = models.TextField(u'备注', blank=True, null=True)
...
class NewAssetApprovalZone(models.Model):
    ...
    approved_by = models.ForeignKey(hosts_models.UserProfile, verbose_name=u'批准人', blank=True, null=True)
